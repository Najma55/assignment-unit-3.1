...
let favoriteFoods = ['pizza', 'burgers', 'Rice', 'tacos'];
...
console.log('added dessert,' , dessert)
...
console.log('Added new Food;' , entree);
...
console.log('removed orange,', firstColor);
console.log('added first color to the beginning,', colors);
